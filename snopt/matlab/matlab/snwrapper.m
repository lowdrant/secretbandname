...
% nargin = 4;   % NOTE (AHC, 10/21): Hack to align process flow between Linux &
                % Mac (it seems Mac mex variant/output triggers different 
                % program flow than Linux mex variant)
if ( nargin == 4 ),
